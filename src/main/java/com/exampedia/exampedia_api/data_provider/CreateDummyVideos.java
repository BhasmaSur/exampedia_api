...
public class CreateDummyVideos {
	...
	public List<Video> getDummyVideosSet1(){
		...
		Video video1 = new Video(1,"Video1","watch it lol","MPSC","defaultvideo1.mp4","VXQlr3Rm");
		Video video2 = new Video(2,"Video3","watch it lol","MPSC","jackDanials.mp4","G10dDpQA");
	...
	public List<Video> getDummyVideosSet2(){
		...
		Video video3 = new Video(3,"Video3","watch it lol","MPSC","defaultvideo1.mp4","VXQlr3Rm");
		Video video4 = new Video(4,"Video4","watch it lol","MPSC","jackDanials.mp4","G10dDpQA");
